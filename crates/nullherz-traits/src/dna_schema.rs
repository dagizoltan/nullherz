...
/// 64-byte aligned SIMD-friendly real-time measurement block
#[repr(C, align(64))]
...
impl Default for PerceptionFrame {
    fn default() -> Self {
        Self {
            timestamp_ns: 0,
            musical_position: MusicalTime::default(),
            bpm: 120.0,
            beat_phase: 0.0,
            downbeat: false,
            pitch_candidate_hz: 440.0,
...
impl Default for AnalysisEventKind {
    fn default() -> Self {
        Self::Transient
    }
}
...
pub struct AnalysisEvent {
    ...
    pub event_type: AnalysisEventKind,
    pub confidence: f32,
    pub energy_db: f32,
    pub min_freq_hz: f32,
    pub max_freq_hz: f32,
...
impl Default for TrackDnaSignature {
    fn default() -> Self {
        Self {
            bpm: 120.0,
            key_root: 0,
