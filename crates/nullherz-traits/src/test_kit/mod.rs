...
impl ConformanceSuite {
    ...
    pub fn verify_simd_alignment(processor: &mut dyn crate::AudioProcessor) -> Result<(), String> {
        ...
        let input_block = crate::AudioBlock { data: [1.0; crate::IPC_BLOCK_SIZE], len: block_size as u32, _pad: [0; 15] };
        let mut output_block = crate::AudioBlock { data: [0.0; crate::IPC_BLOCK_SIZE], len: block_size as u32, _pad: [0; 15] };
