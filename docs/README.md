...
- [Sound Analysis & Perception System](./system/SOUND_ANALYSIS_PERCEPTION_SYSTEM_SPECIFICATION.md) — real-time audio perception subsystem, multi-timescale analysis, Analysis Bus, spectral field UI, rhythm, collision, trajectories, and control routing
